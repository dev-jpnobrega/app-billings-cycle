...
namespace MyMoney.Droid.Service
{
    ...
    {
        public static string[] SENDER_IDS = new string[] { "1008723114622" };
    }

    [Service]
    public class GcmService : GcmServiceBase
    {
        MobileServiceClient client = new MobileServiceClient(MyMoney.Helpers.Settings.UrlPushAzure);
        ...
        protected override void OnMessage(Context context, Intent intent)
        {
            ...
            {
                createNotification("Nova mensagem", msg2);
                return;
            }
